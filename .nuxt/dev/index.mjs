...
import { defineEventHandler, handleCacheHeaders, splitCookiesString, isEvent, createEvent, fetchWithEvent, getRequestHeader, eventHandler, setHeaders, sendRedirect, proxyRequest, createError, setResponseHeader, send, getResponseStatus, setResponseStatus, setResponseHeaders, getRequestHeaders, createApp, createRouter as createRouter$1, toNodeListener, lazyEventHandler, getRouterParam, getQuery as getQuery$1, readBody, getResponseStatusText } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/h3/dist/index.mjs';
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/vue-bundle-renderer/dist/runtime.mjs';
import { stringify, uneval } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/devalue/index.js';
import destr from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/destr/dist/index.mjs';
import { parseURL, withoutBase, joinURL, getQuery, withQuery, withTrailingSlash, joinRelativeURL } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/ufo/dist/index.mjs';
import { renderToString } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/vue/server-renderer/index.mjs';
import { hash } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/ohash/dist/index.mjs';
import { renderSSRHead } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/@unhead/ssr/dist/index.mjs';
import { createFetch as createFetch$1, Headers as Headers$1 } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/ofetch/dist/node.mjs';
import { createCall, createFetch } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/unenv/runtime/fetch/index.mjs';
import { createHooks } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/hookable/dist/index.mjs';
import { klona } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/klona/dist/index.mjs';
import { snakeCase } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/scule/dist/index.mjs';
import defu, { defuFn } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/defu/dist/defu.mjs';
import { createStorage, prefixStorage } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/unstorage/drivers/fs.mjs';
import { toRouteMatcher, createRouter } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/radix3/dist/index.mjs';
import { AsyncLocalStorage } from 'node:async_hooks';
import { consola } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/consola/dist/index.mjs';
import { getContext } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/unctx/dist/index.mjs';
import { version, unref } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/vue/index.mjs';
import { createServerHead as createServerHead$1 } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/unhead/dist/index.mjs';
import { defineHeadPlugin } from 'file:///Users/macmarek/Desktop/vehis-calculator/node_modules/@unhead/shared/dist/index.mjs';
...
const serverAssets = [{"baseName":"server","dir":"/Users/macmarek/Desktop/vehis-calculator/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/macmarek/Desktop/vehis-calculator","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/macmarek/Desktop/vehis-calculator/server","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/macmarek/Desktop/vehis-calculator/.nuxt","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/macmarek/Desktop/vehis-calculator/.nuxt/cache","ignore":["**/node_modules/**","**/.git/**"]}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/macmarek/Desktop/vehis-calculator/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const _AgyjpamH4t = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/macmarek/Desktop/vehis-calculator";

const asyncContext = getContext("nuxt-dev", { asyncContext: true, AsyncLocalStorage });
const _xnv15kmXpm = (nitroApp) => {
...
const _lazy_ocTKVw = () => Promise.resolve().then(function () { return calculateinstallments$1; });
const _lazy_MLmBaK = () => Promise.resolve().then(function () { return calculateinsurance$1; });
const _lazy_Cf2Mg7 = () => Promise.resolve().then(function () { return renderer$1; });

const handlers = [
  { route: '/api/calculateinstallments', handler: _lazy_ocTKVw, lazy: true, middleware: false, method: undefined },
  { route: '/api/calculateinsurance', handler: _lazy_MLmBaK, lazy: true, middleware: false, method: undefined },
  { route: '/__nuxt_error', handler: _lazy_Cf2Mg7, lazy: true, middleware: false, method: undefined },
  { route: '/**', handler: _lazy_Cf2Mg7, lazy: true, middleware: false, method: undefined }
];
...
const calculateinstallments = defineEventHandler(async (event) => {
...
const calculateinstallments$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: calculateinstallments
});

const calculateinsurance = defineEventHandler(async (event) => {
  const requestBody = await readBody(event);
  ...
  if (netCarValue < 4e4) {
    factor = 8;
  } else if (netCarValue >= 4e4 && netCarValue < 1e5) {
    factor = 5;
  } else if (netCarValue >= 1e5 && netCarValue < 2e5) {
    factor = 4;
  } else if (netCarValue >= 2e5 && netCarValue < 400001) {
    factor = 2;
  }
...
const calculateinsurance$1 = /*#__PURE__*/Object.freeze({
  __proto__: null,
  default: calculateinsurance
});
...
const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"}],"link":[],"style":[],"script":[],"noscript":[],"title":"Kalkulator OC/AC"};
...
const getClientManifest = () => import('file:///Users/macmarek/Desktop/vehis-calculator/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
const getServerEntry = () => import('file:///Users/macmarek/Desktop/vehis-calculator/.nuxt/dist/server/server.mjs').then((r) => r.default || r);
